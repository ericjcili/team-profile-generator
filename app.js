    ...
    return new Promise(function(resolve, reject) {
        ...
        if (role === "Engineer") {
            ...
            <ul class="list-group list-group-flush">
                <a class="list-group-item">ID: ${id}</a>
                <a href="mailto: ${email}" class="list-group-item list-group-item-action">Email Address: ${email}</a>
                <a href="https://github.com/${gitHub}" class="list-group-item list-group-item-action">GitHub: ${gitHub}</a>
            </ul>
            </div>
        </div>`;
        } else if (role === "Intern") {
            ...
            <ul class="list-group list-group-flush">
                <a class="list-group-item">ID: ${id}</a>
                <a href="mailto: ${email}" class="list-group-item list-group-item-action">Email Address: ${email}</a>
                <a class="list-group-item">School: ${school}</a>
            </ul>
            </div>
        </div>`;
        } else {
            ...
            <ul class="list-group list-group-flush">
                <a class="list-group-item">ID: ${id}</a>
                <a href="mailto: ${email}" class="list-group-item list-group-item-action">Email Address: ${email}</a>
                <a class="list-group-item">Office Phone: ${officePhone}</a>
            </ul>
            </div>
        </div>`
        }
